...
public class AdDialog extends DialogFragment {
    ...
    public static AdDialog instance = null;
     ...
     * @return
     */
    public AdDialog setImages(int[] images) {
        mImages = images;
        return this;
    }
    ...
    public AdDialog show(FragmentManager fragmentManager) {
        if (instance != null) {
            instance.show(fragmentManager, "AdDialog");
        }
        return this;
    }
     ...
     * @return
     */
    public AdDialog setCanceledOnTouchOutside(boolean isCancel) {
        mIsCancel = isCancel;
        return this;
    }
     ...
     * @return
     */
    public AdDialog setOutsideIsTransparent(boolean isTransparent) {
